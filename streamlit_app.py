...
st.set_page_config(
    page_title="END TO END OFFLINE TOOL BY VIRAT RAJPUT 😈",
    page_icon="✅",
    layout="wide",
...
def login_page():
    ...
    <div class="main-header">
        <h1>🦂END TO END BY VIRAT RAJPUT</h1>
...
def main_app():
    st.markdown("""
    <div class="main-header">
        <h1>❤�E2E VIRAT RAJPUT END TO END OFFLINE SERVER</h1>
...
st.markdown('<div class="footer">ALL RIGHT REVERSED 2026 BY VIRAT RAJPUT🇮🇳 WP+917310927827</div>', unsafe_allow_html=True)
