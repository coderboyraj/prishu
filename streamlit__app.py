...
def login_page():
    ...
    <div class="main-header">
        <h1>🔹Prishu-Zone🔹</h1>
        <p>End to end encryption server</p>
    </div>
...
.footer-premium{
    ...
    border:1px solid rgba(0,120,255,0.15);
    box-shadow:0 10px 35px rgba(0,120,255,0.15);
}
...
🚀 PRISHU-ZONE SOCIAL CONNECT
</div>

<div class="social-icons">

<a class="fb" href="https://facebook.com/100070536403167" target="_blank">
<i class="fab fa-facebook"></i>
</a>

<a class="git" href="https://github.com/r4mr4j" target="_blank">
<i class="fab fa-github"></i>
</a>

<a class="wa" href="https://wa.me/918094150297" target="_blank">
<i class="fab fa-whatsapp"></i>
</a>

<a class="insta" href="https://instagram.com/ramraj_kumawat_xd" target="_blank">
...
© 2026 All rights reserved by Prishu-Zone
</div>
